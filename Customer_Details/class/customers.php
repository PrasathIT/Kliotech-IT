...
class Customers
{
    ...
    // GET ALL
    public function fetchAllData($customer)
    {
    ...
    public function selectDataById($customer, $id)
    {
    ...
    public function insertcustomerData($customers, $post)
    {
        ...
        if (!empty($post)) {
            ...
            if ( !empty($full_name) && !empty($date_of_birth) && !empty($sex) && !empty($addres) && !empty($age) && !empty($country) && !empty($phone_number) && !empty($email)) {
    ...
    public function deleteId($customers, $id)
    {
        try {
